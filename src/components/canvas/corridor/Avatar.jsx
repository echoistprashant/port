...
const Avatar = ({ position = [10, -20, 30] }) => {
    ...
    useFrame((state, delta) => {
        ...
        // === FRAME ANIMATION LOGIC (PING-PONG) OR BREATHING SWAY (OPTION B) ===
        ...
        // Subtle breathing & waving micro-movement (Option B)
        meshRef.current.position.y = Math.sin(time * 2.2) * 0.03;
        meshRef.current.scale.y = 1 + Math.sin(time * 1.8) * 0.015;
    });
