...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'PRASHANT', subtitle: '< ai developer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'HIGHLIGHTS', subtitle: 'Founding Member @ Femur Studio • 5 AI Projects Shipped' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'B.Tech CSE @ Central University of Chhattisgarh' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Python • TypeScript • React • Next.js • FastAPI • PostgreSQL • LLMs' },
];
