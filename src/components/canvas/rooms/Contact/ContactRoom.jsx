...
const ContactRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const handleMailSelect = () => {
        // Mailto redirection fallback
        window.location.href = 'mailto:yadavprashant100804@gmail.com';
    ...
    return (
        <group ref={groupRef} position={[0, -0.7, -5]}>
            ...
            <SocialBarrel
                ...
                label="LINKEDIN"
                onClick={() => window.open('https://www.linkedin.com/in/echoistprashant/', '_blank')}
            ...
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="GITHUB"
                onClick={() => window.open('https://github.com/echoistprashant', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* X / TWITTER */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="X (TWITTER)"
                onClick={() => window.open('https://x.com/ConstPrashant', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
            {/* INSTAGRAM */}
            <SocialBarrel
                ...
                texturePath="/textures/contact/beczka.webp"
                label="INSTAGRAM"
                onClick={() => window.open('https://www.instagram.com/echoistprashant/', '_blank')}
                paintOnBeforeCompile={onBeforeCompile}
                paintUniforms={uniformsData}
            />
